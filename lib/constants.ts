...
export const SUGGESTED_PROMPTS = [
  ...
  // },
  {
    title: "Flashcard app",
    description:
      "Build me a flashcard app for learning any topic. The app should come with some example flashcards and allow users to add their own. Show one side of a card at first, then reveal the answer on button click. Keep track of correct guesses to measure progress.",
  },
  {
